...
public:
    ...
    VARIANT_BOOL	    m_bMouseMoveCursor;
    ...
    // TBR
    STDMETHOD(get_Colors)(OLE_COLOR *[10]);
    STDMETHOD(put_Colors)(const OLE_COLOR [10]);
